...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1>Edit Hotel</h1>
            <p>Modifier les détails de votre établissement</p>
        </div>
        <form action="${pageContext.request.contextPath}/MettreAJourHotelServlet" method="post" enctype="multipart/form-data" class="form-grid">
            <!-- Hidden ID for identifying the hotel -->
            <input type="hidden" name="id" value="${param.id}" />

            <div class="form-group">
                <label for="name"><i class="fas fa-building"></i>Nom de l'Hôtel</label>
                <input type="text" id="name" name="name" value="${param.name}" placeholder="Ex: Grand Palace Resort" required>
            </div>

            <div class="form-group">
                <label for="city"><i class="fas fa-map-marker-alt"></i>Ville</label>
                <input type="text" id="city" name="city" value="${param.city}" placeholder="Ex: Paris" required>
            </div>

            <div class="form-group">
                <label for="stars"><i class="fas fa-star"></i>Nombre d'Étoiles</label>
                <input type="number" id="stars" name="stars" value="${param.stars}" min="1" max="5" placeholder="1-5" required>
            </div>
            ...
            <div class="form-group full-width">
                ...
                <textarea id="description" name="description" placeholder="Décrivez votre hôtel en détail..." rows="5" required>${param.description}</textarea>
            </div>

...
<body>
    <div class="container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="hotel-image" src="images/<%=hotel.getImage()%>" alt="Hotel" onclick="openModal('images/<%=hotel.getImage()%>')">
                        </td>
                        <td>
                            <button class="btn btn-edit" onclick="window.location.href='Vue/editHotel.jsp?id=<%= hotel.getId() %>'">Edit</button>
        ...
        <div class="section">
            ...
            <div class="actions">
                <button class="btn btn-add" onclick="window.location.href='Vue/addRoomType.jsp'">Add Room</button>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-edit" onclick="window.location.href='Vue/editRoom.jsp?id=<%= room.getId() %>'">Edit</button>
    ...
    <script>
        ...
        function deleteHotel(hotelId) {
            if (confirm('Are you sure you want to delete this hotel?')) {
                fetch('SupprimerHotelServlet?id=' + hotelId, {
                    method: 'GET',
                })
        ...
        function deleteRoom(roomId) {
            if (confirm('Are you sure you want to delete this room?')) {
                fetch('SupprimerRoomTypeServlet?id=' + roomId, {
                    method: 'GET',
                })
                .then(response => response.text())
                .then(data => {
        ...
        function logout() {
            window.location.href = 'Vue/logout';
        }
    </script>
</body>
</html>